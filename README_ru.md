...
<h1 align="center">Самет Джырык (Samet Cırık)</h1>

<p align="center">
  Разработчик программного обеспечения, специализирующийся на разработке игр (C# и Unity) и десктопных UI/UX приложениях (Java).
</p>
...
<h3 align="center">Основные проекты</h3>

* **[Solitaire](https://github.com/SametCirik/Solitaire)**: Исследование движка карточных игр, разработанное на Java Swing.
* **[WhatsApp KYK Bot](https://github.com/SametCirik/Whatsapp-KYK-Bot)**: Сервисное приложение, ориентированное на эффективность и автоматизацию.
* **[Folder To Text](https://github.com/SametCirik/FolderToText)**: Утилита для документирования структуры каталогов.
* **[InkEra Drawing App](https://github.com/SametCirik/InkEra)**: Концепция современного интерфейса для рисования (В разработке).
