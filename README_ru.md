...
<p align="center">
  Студент факультета мехатроники и младший разработчик<br>
  Специализируюсь на <b>UI/UX дизайне</b>, <b>Java Desktop (Swing/JavaFX)</b> и <b>анализе данных</b>.
</p>
...
<p align="center">
  <b><a href="https://github.com/SametCirik/InkEra">InkEra Studio Drawing App</a></b>: Современная концепция интерфейса для рисования (В разработке).<br>
  <b><a href="https://github.com/SametCirik/Fountext-Screenwriting-Editor">Fountext Screenwriting Editor</a></b>: Редактор сценариев Fountain, написанный на Python для Linux.<br>
  <b><a href="https://github.com/SametCirik/Whatsapp-KYK-Bot">WhatsApp KYK Bot</a></b>: Сервисное приложение, ориентированное на эффективность и автоматизацию.<br>
  <b><a href="https://github.com/SametCirik/FolderToText">Folder To Text</a></b>: Утилита для документирования структур каталогов.<br>
  <b><a href="https://github.com/SametCirik/SC-Hotspot">SC Hotspot</a></b>: Динамический сетевой мост Wi-Fi и TUI-утилита, предотвращающая аппаратные конфликты в Linux.<br>
  <b><a href="https://github.com/SametCirik/Solitaire">Solitaire</a></b>: Исследование движка карточной игры, разработанное на Java Swing.<br>
  <b><a href="https://github.com/SametCirik/Base">Base</a></b>: Мобильное приложение-геймпад для Linux (С фокусом на разработку мобильного UI).
</p>
