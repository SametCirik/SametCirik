...
Je suis un passionné de technologie axé sur la recherche de solutions par des **méthodes non conventionnelles**, apprenant toujours de mes erreurs pour aller de l'avant.

J'utilise fréquemment le développement assisté par IA ("vibe coding") pour prototyper et donner vie à des idées. Bien que ce soit un moyen puissant d'apprendre, mon objectif actuel est de réduire ma dépendance à ces outils et de renforcer mes compétences fondamentales pour travailler de manière plus autonome.

Pour moi, le codage est plus qu'un simple outil ; c'est l'art de construire mes propres solutions et ma vision à partir de zéro. Je suis actuellement actif dans le **Développement de Jeux (C# & Unity)** et les **Applications UI/UX de Bureau (Java)**.

Jetez un œil aux projets qui me passionnent le plus et auxquels je crois un fort potentiel. ***Chaque ligne de code que j'écris est une histoire d'apprentissage et de progrès.***
...
- [InkEra Drawing App](https://github.com/SametCirik/InkEra) *(pas encore prêt)*
- [Graphite - *Forked*](https://github.com/SametCirik/Graphite) *(pas encore commencé)*
