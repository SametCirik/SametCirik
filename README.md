...
I'm a technology enthusiast focused on finding solutions through **unconventional methods**, always learning from my mistakes to push myself forward.

I frequently leverage AI-assisted development ("vibe coding") to prototype and bring ideas to life. While this is a powerful way to learn, my current focus is on reducing my reliance on these tools and strengthening my core fundamental skills to work more independently.

For me, coding is more than just a tool; it's the art of building my own solutions and vision from the ground up. I am currently active in **Game Development (C# & Unity)** and **Desktop UI/UX Applications (Java)**.
